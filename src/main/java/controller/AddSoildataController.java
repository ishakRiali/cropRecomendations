...
public class AddSoildataController {
    private AddSoildata ap;
    private Soildata Soildata;
    public AddSoildataController(AddSoildata ap){
        this.ap=ap; this.Soildata= new Soildata();
    }
       ...
       // ap.getImc().setEditable(false);
        ...
        ap.getAjouter().addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                String echantillon,N,P,K,Ph,Temperature,Humidity,Rainfall;
                echantillon=ap.getEchantillon().getText().toString();
                N=ap.getN().getText().toString();
                P=ap.getP().getText().toString();
                K= ap.getK().getText().toString();
                Ph=ap.getPh().getText().toString();
                Temperature=ap.getTemperature().getText().toString();
                Humidity=ap.getHumidity().getText().toString();
                Rainfall=ap.getRainfall().getText().toString();
                
                //Stocker ces infos dans un patient qui sera ajouté
                Soildata.setechantillon(echantillon);
                Soildata.setN(N);
                Soildata.setP(P);
                Soildata.setK(K);
                Soildata.setPh(Ph);
                ...
                
                {
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "Echantillon ajouté!", "Information", JOptionPane.INFORMATION_MESSAGE);
